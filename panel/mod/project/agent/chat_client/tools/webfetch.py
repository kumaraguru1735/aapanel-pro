...
@register_tool(category="Network", name_cn="Web Fetch", risk_level="low")
def WebFetch(url: str, format: str = "markdown", timeout: Optional[int] = None, **kwargs) -> str:
    ...
    When to use:
    - Retrieve external documentation, API responses, or web page content
    - Fetch data from public APIs or remote endpoints
    - Summarize or analyze web content
