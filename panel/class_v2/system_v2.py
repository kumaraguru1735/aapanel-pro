...
class system:
    ...
    def RepPanel(self,get):
        return public.return_message(-1, 0, 'Panel repair is disabled in this build.')

    def UpdatePro(self,get):
        return public.return_message(-1, 0, 'Panel upgrade is disabled in this build.')
    ...
    def repair_panel(self, get):
        return public.fail_v2('Panel repair is disabled in this build.')

    def upgrade_panel(self, get):
        return public.fail_v2('Panel upgrade is disabled in this build.')
