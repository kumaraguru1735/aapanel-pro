# coding: utf-8
# Web Application Firewall plugin stub
import public
import os
...
class btwaf_main:
    ...
    def index(self, args):
        ...
        return make_response('<p>Web Application Firewall - Plugin managed via system daemon.</p>', 200, {'Content-Type': 'text/html; charset=utf-8'})
