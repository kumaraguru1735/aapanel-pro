# coding: utf-8
# System Hardening plugin stub
import public
import os

class syssafe_main:
    _plugin_path = '/www/server/panel/plugin/syssafe'
    ...
    def index(self, args):
        ...
        return make_response('<p>System Hardening - Plugin managed via system daemon.</p>', 200, {'Content-Type': 'text/html; charset=utf-8'})
