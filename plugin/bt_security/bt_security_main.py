# coding: utf-8
# Firewall Security plugin stub
import public
import os

class bt_security_main:
    _plugin_path = '/www/server/panel/plugin/bt_security'
    ...
    def index(self, args):
        ...
        return make_response('<p>Firewall Security - Plugin managed via system daemon.</p>', 200, {'Content-Type': 'text/html; charset=utf-8'})
