...
class jumpserver_main:
    _plugin_path = '/www/server/panel/plugin/jumpserver'
    ...
    def index(self, args):
        ...
        return make_response('<p>Jump Server - Plugin managed via system daemon.</p>', 200, {'Content-Type': 'text/html; charset=utf-8'})
