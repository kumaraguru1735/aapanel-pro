# coding: utf-8
# System Monitor plugin stub
import public
import os

class monitor_main:
    _plugin_path = '/www/server/panel/plugin/monitor'
    ...
    def index(self, args):
        ...
        return make_response('<p>System Monitor - Plugin managed via system daemon.</p>', 200, {'Content-Type': 'text/html; charset=utf-8'})
