# coding: utf-8
# File Sync (rsync) plugin stub
import public
import os

class rsync_main:
    _plugin_path = '/www/server/panel/plugin/rsync'
    ...
    def index(self, args):
        ...
        return make_response('<p>File Sync (rsync) - Plugin managed via system daemon.</p>', 200, {'Content-Type': 'text/html; charset=utf-8'})
