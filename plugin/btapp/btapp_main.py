# coding: utf-8
# aaPanel Mobile plugin stub
import public
import os

class btapp_main:
    _plugin_path = '/www/server/panel/plugin/btapp'
    ...
    def index(self, args):
        ...
        return make_response('<p>aaPanel Mobile - Plugin managed via system daemon.</p>', 200, {'Content-Type': 'text/html; charset=utf-8'})
