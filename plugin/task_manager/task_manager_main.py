# coding: utf-8
# Task Manager plugin stub
import public
import os

class task_manager_main:
    _plugin_path = '/www/server/panel/plugin/task_manager'
    ...
    def index(self, args):
        ...
        return make_response('<p>Task Manager - Plugin managed via system daemon.</p>', 200, {'Content-Type': 'text/html; charset=utf-8'})
