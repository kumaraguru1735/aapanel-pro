...
Install_centos7()
{
  ...
  wget -O /tmp/postfix3-3.4.7-1.gf.el7.x86_64.rpm $download_Url/install/plugin/mail_sys/rpm/postfix3-3.4.7-1.gf.el7.x86_64.rpm --no-check-certificate
  yum localinstall /tmp/postfix3-3.4.7-1.gf.el7.x86_64.rpm -y
  wget -O /tmp/postfix3-sqlite-3.4.7-1.gf.el7.x86_64.rpm $download_Url/install/plugin/mail_sys/rpm/postfix3-sqlite-3.4.7-1.gf.el7.x86_64.rpm --no-check-certificate
...
{
  if [[ $systemver = "7" ]];then
    wget -O /etc/yum.repos.d/rspamd.repo https://rspamd.com/rpm-stable/centos-7/rspamd.repo --no-check-certificate
...
#    sudo apt install rspamd -y
    ...
    wget -O- https://rspamd.com/apt-stable/gpg.key --no-check-certificate| gpg --dearmor | sudo tee /etc/apt/keyrings/rspamd.gpg > /dev/null
...
Install_centos8()
{
  ...
  # 安装postfix和postfix-sqlite
  wget -O /tmp/postfix3-3.4.9-1.gf.el8.x86_64.rpm $download_Url/install/plugin/mail_sys/rpm/postfix3-3.4.9-1.gf.el8.x86_64.rpm --no-check-certificate
  yum localinstall /tmp/postfix3-3.4.9-1.gf.el8.x86_64.rpm -y
  wget -O /tmp/postfix3-sqlite-3.4.9-1.gf.el8.x86_64.rpm $download_Url/install/plugin/mail_sys/rpm/postfix3-sqlite-3.4.9-1.gf.el8.x86_64.rpm --no-check-certificate
...
Install_ubuntu()
{
  ...
  # 安装dovecot和dovecot-sieve
  sudo apt install dovecot-core dovecot-pop3d dovecot-imapd dovecot-lmtpd dovecot-sqlite dovecot-sieve dovecot-managesieved -y
  # 安装opendkim
...
Install()
{
  ...
  if [ "$?" -ne 0 ];then
    wget -O $pluginPath/mail_sys_main.py $download_Url/install/plugin/mail_sys/mail_sys_main.py -T 20 --no-check-certificate
    wget -O $pluginPath/receive_mail.py $download_Url/install/plugin/mail_sys/receive_mail.py -T 20 --no-check-certificate
    wget -O $pluginPath/index.html $download_Url/install/plugin/mail_sys/index.html -T 20 --no-check-certificate
    wget -O $pluginPath/info.json $download_Url/install/plugin/mail_sys/info.json -T 20 --no-check-certificate
    wget -O $pluginPath/icon.png $download_Url/install/plugin/mail_sys/icon.png -T 20 --no-check-certificate
    wget -O $pluginStaticPath/api.zip $download_Url/install/plugin/mail_sys/api.zip -T 20 --no-check-certificate
    wget -O /www/server/panel/BTPanel/static/ckeditor.zip $download_Url/install/plugin/mail_sys/ckeditor.zip -T 20 --no-check-certificate
  else
    wget -O $pluginPath/install.sh $download_Url/install/plugin/mail_sys_en/install.sh -T 20 --no-check-certificate
    wget -O $pluginPath/mail_sys_main.py $download_Url/install/plugin/mail_sys_en/mail_sys_main.py -T 20 --no-check-certificate
    wget -O $pluginPath/services_file.txt $download_Url/install/plugin/mail_sys_en/services_file.txt -T 20 --no-check-certificate
    wget -O $pluginPath/mail_server_init.py $download_Url/install/plugin/mail_sys_en/mail_server_init.py -T 20 --no-check-certificate
    wget -O $pluginPath/receive_mail.py $download_Url/install/plugin/mail_sys_en/receive_mail.py -T 20 --no-check-certificate
    wget -O $pluginPath/index.html $download_Url/install/plugin/mail_sys_en/index.html -T 20 --no-check-certificate
    wget -O $pluginPath/info.json $download_Url/install/plugin/mail_sys_en/info.json -T 20 --no-check-certificate
    wget -O $pluginPath/icon.png $download_Url/install/plugin/mail_sys_en/icon.png -T 20 --no-check-certificate
    wget -O $pluginStaticPath/api.zip $download_Url/install/plugin/mail_sys_en/api.zip -T 20 --no-check-certificate
    wget -O /www/server/panel/BTPanel/static/ckeditor.zip $download_Url/install/plugin/mail_sys_en/ckeditor.zip -T 20 --no-check-certificate
  fi
...
Uninstall()
{
  if [[ $systemver = "7" ]];then
    ...
    sudo apt remove dovecot-core dovecot-imapd dovecot-lmtpd dovecot-pop3d dovecot-sqlite dovecot-sieve dovecot-managesieved -y
