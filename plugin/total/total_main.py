# coding: utf-8
# Total Statistics plugin stub
import public
import os

class total_main:
    _plugin_path = '/www/server/panel/plugin/total'
    ...
    def index(self, args):
        ...
        return make_response('<p>Total Statistics - Plugin managed via system daemon.</p>', 200, {'Content-Type': 'text/html; charset=utf-8'})
