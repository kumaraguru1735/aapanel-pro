# coding: utf-8
# Load Balance plugin stub
import public
import os

class load_balance_main:
    _plugin_path = '/www/server/panel/plugin/load_balance'
    ...
    def index(self, args):
        ...
        return make_response('<p>Load Balance - Plugin managed via system daemon.</p>', 200, {'Content-Type': 'text/html; charset=utf-8'})
